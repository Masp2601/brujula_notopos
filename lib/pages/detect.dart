...
class _ImageDetectionPageState extends State<ImageDetectionPage> {
  ...
  Future _speak() async {
    ...
    if (_distance != 0) {
      var result =
          await flutterTts.speak('Distancia de la Ciudad es $_distance meters');
  ...
  void _getlocation() async {
    ...
    final double _facultypositionlat = 7.0682000;
    final double _facultypositionlong = -73.1698100;
              ...
              : Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text(' Distancia de la Ciudad : $_distance m.',
                          style: TextStyle(
                              fontSize: 18,
